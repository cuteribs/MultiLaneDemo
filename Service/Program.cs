...
public class Program
{
	...
	public static void Main(string[] args)
	{
		...
		{
			services.AddHttpClient(TargetService1, (sp, client) =>
			{
				client.BaseAddress = new Uri($"{baseUrl}");
				client.DefaultRequestHeaders.Add("service", TargetService1);
			});
		}

		if (TargetService2 != null)
		{
			services.AddHttpClient(TargetService2, (sp, client) =>
			{
				client.BaseAddress = new Uri($"{baseUrl}");
				client.DefaultRequestHeaders.Add("service", TargetService2);
			});
		}
